...
function cadRegistroProntuario() {
    ...
    if (!animalSelecionadoJson) {
        ...
        fetch("https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/prontuario/gravar", {
            method: "POST",
            body: formData,
...
async function editarRegistroProntuario(){
    const token = localStorage.getItem("token");
 const URL = "https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/prontuario/atualizar";
...
function buscarRegistroPeloId(id) {
    const token = localStorage.getItem("token");
    const URL = "https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/prontuario/buscar-id/" + id;
    ...
    fetch(URL, {
        ...
        .then((json) => {
            ...
            if (json.arquivo) {
                ...
                link.href = `https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/prontuario/arquivo/${json.cod}`;
                link.target = '_blank';
