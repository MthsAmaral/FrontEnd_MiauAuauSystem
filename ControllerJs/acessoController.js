...
{
  const url = "https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/usuario/buscar-email/"+email;
...
{
  const url = "https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/usuario/buscar-cpf/"+cpf;
...
function buscarUsuarioPeloId()
{
    ...
    if (token)
    {
      ...
      if (flag == 1)
      {
        const URL = "https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/usuario/buscar-id/"+payload.cod_usuario;
        fetch(URL, {
            headers: {
...
function buscarAdocaoPeloUsuId()
{
  ...
  if (token)
  {
    ...
    {
      console.log(filtro)
      const url = `https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/adocao/buscarAdocaoPeloUsuId/${payload.cod_usuario}/`+filtro;
      fetch(url, {
      ...
      const url = `https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/adocao/buscarAdocaoPeloUsuId/${payload.cod_usuario}/%20`;
      fetch(url, {
        method: 'GET', redirect: "follow", headers: { 'Authorization': token }
      })
        .then((response) => {
