...
function selectTpLanc(id) {
  ...
  let URL = "";
  URL = "https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/tipo-lancamento/buscar/%20";
  fetch(URL, {
    method: 'GET',
...
function selectAnimal(id) {
  ...
  let URL = "";
  URL = "https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/animal/buscar/%20";
  fetch(URL, {
    method: 'GET',
    headers: { 'Authorization': token },
    redirect: "follow"
...
function selectDebCred(deb, cred) {
  ...
  const token = localStorage.getItem("token");
  let URL = "";
  URL = "https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/plano-contas-gerencial/buscar/%20";
  fetch(URL, {
    method: 'GET',
    headers: { 'Authorization': token },
    redirect: "follow"
...
function cadLancamento() {
  const token = localStorage.getItem("token");
  let URL = "https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/lancamento/gravar";
...
function buscarLancamentosFiltro() {
  const token = localStorage.getItem("token");
  let URL = "https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/lancamento/buscar-filtro";
  let tudo = false;
  let fezFiltro = false;
      ...
      .then(function (text) {
        ...
        for (let i = 0; i < json.length; i++) {
          ...
          const linkPDF = json[i].arquivo
            ? `<a href="https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/lancamento/arquivo/${json[i].cod}"
...
function excluirLancamento(id) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      const token = localStorage.getItem("token");
      let URL = "https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/lancamento/excluir/" + id;
...
async function editarLancamento() {
  const token = localStorage.getItem("token");
  const URL = "https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/lancamento/atualizar";
...
function buscarLancID(id) {
  const token = localStorage.getItem("token");
  let url = "https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/lancamento/buscar-id/" + id;
    ...
    .then((json) => {
      ...
      if (json.arquivo) {
        ...
        link.dataset.url =                      // guardamos a URL real aqui
          `https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/lancamento/arquivo/${json.cod}`;
