...
function cadTipoPagamento() {
    ...
    const URL = "https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/plano-contas-gerencial/gravar";
...
function buscarTipoPagamento(filtro) {
    ...
    let url = "https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/plano-contas-gerencial/buscar";
    const token = localStorage.getItem("token");
...
function buscarTipoPagID(id) {
    // deixar um espaço ao final da string para buscar por todos os registros já cadastrados
    let url = "https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/plano-contas-gerencial/buscar-id/" + id;
    const token = localStorage.getItem("token");
...
function selectReferencial(id) {
    ...
    let URL = "";
    URL = "https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/plano-contas-referencial/buscar/%20";
    const token = localStorage.getItem("token");
...
function excluirTipoPagamento(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            const URL = "https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/plano-contas-gerencial/excluir/" + id;
            const token = localStorage.getItem("token");
...
function editarTipoPag() {
    const token = localStorage.getItem("token");
    const URL = "https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/plano-contas-gerencial/atualizar";
