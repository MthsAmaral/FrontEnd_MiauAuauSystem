...
function cadDoacao() {
  ...
  const url = cod
    ? "https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/doacao/atualizar"
    : "https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/doacao/gravar";
...
function buscarDoacao() {
  ...
  const url = filtro.length > 0
    ? "https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/doacao/buscar/" + filtro
    : "https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/doacao/buscar/%20";
...
function excluirDoacao(id) {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      const URL = "https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/doacao/excluir/" + id;
...
function confirmarDoacao(id) {
  ...
  fetch(`https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/doacao/buscar-id/${id}`, {
    method: "GET",
    headers: { 'Authorization': token }
  })
    ...
    .then(doacao => {
      ...
      return fetch("https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/doacao/atualizar", {
        method: "PUT",
        headers: {
          'Authorization': token,
          "Content-Type": "application/x-www-form-urlencoded"
...
function buscarDoacoesPeloUsuId() {
  ...
  fetch(`https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/doacao/buscarPorUsuario/${cod_usuario}`, {
    method: 'GET',
    headers: {
      'Authorization': token,
      'Content-Type': 'application/json'
