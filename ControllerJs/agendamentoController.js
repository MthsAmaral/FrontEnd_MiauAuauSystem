  ...
  if (!medicamentoSelecionado || !medicamentoSelecionado.cod) {
    ...
    if (!animaisSelecionados || animaisSelecionados.length === 0) {
      ...
      if (codAgendamento) {
        ...
        fetch("https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/agendar-medicamento/atualizar", {
          method: "PUT",
        ...
        const promessas = animaisSelecionados.map(animal => {
          ...
          return fetch("https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/agendar-medicamento/gravar", {
            method: "POST",
            headers: { 'Authorization': token },
            body: formData
          });
...
function carregarAgendamentos() {
  ...
  const url = "https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/agendar-medicamento/buscar/" +
...
function editarAgendamento(codAgendarMedicamento) {
  const token = localStorage.getItem("token");
  fetch(`https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/agendar-medicamento/buscar-id/${codAgendarMedicamento}`,{
    headers: { 'Authorization': token }
  })
    .then(response => {
      if (!response.ok) {
...
function excluirAgendamento(id) {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      const URL = "https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/agendar-medicamento/excluir/" + id;
...
function carregarMedicamentos() {
  ...
  fetch("https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/tipo-medicamento/buscar/%20",{
    headers: { 'Authorization': token }
  })
    .then(response => {
      if (!response.ok) {
...
function carregarNotificacoes() {
  ...
  const url = "https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/agendar-medicamento/buscar/%20"; // espaço codificado como %20 para simular "sem filtro"
...
function atualizarStatusAgendamento(id, novoStatus) {
  const token = localStorage.getItem("token");
  fetch(`https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/agendar-medicamento/buscar-id/${id}`,{
    headers: { 'Authorization': token }
  })
    ...
    .then(agendamento => {
      ...
      return fetch("https://backend-miauauau-7bacd44b7104.herokuapp.com/apis/agendar-medicamento/atualizar", {
        method: "PUT",
        headers: { 'Authorization': token },
        body: formData
      });
